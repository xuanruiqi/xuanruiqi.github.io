...
**Lemma** (splitting lemma): for a short exact sequence
...
**Proof of Theorem 1**: let $\{w_i\}$ be a basis of $W$. Since $g$ is necessarily surjective,
...
**Proof of rank-nullity**: at this point, the rank-nullity theorem is almost trivial. Simply consider
...
**Theorem 2** (the first isomorphism theorem): let $M, N$ be modules over a base ring,
...
**Alternate proof**: simply take the dimension on both sides in the isomorphism given by the first isomorphism
theorem.
